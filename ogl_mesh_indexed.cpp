// Ogl indexed vertices mesh sample. Rendered by glDrawElements function (for OpenGL ES 3.2).
#include <array>
#include <iostream>
#include <cassert>
#include <SDL.h>
...
constexpr GLfloat xy_plane_verts[] = {
	0.f, 0.f, 0.f,
	1.f, 0.f, 0.f,
	1.f, 1.f, 0.f,
	0.f, 1.f, 0.f
...
constexpr array<GLuint, 6> xy_plane_indices = {
	0, 1, 2,  2, 3, 0
};
...
int main([[maybe_unused]] int argc, [[maybe_unused]] char * argv[]) {
	...
	{  // scope to destroy ogl stuff before GL context delete
		...
		ogl::mesh xy_plane{xy_plane_verts, sizeof(xy_plane_verts), xy_plane_indices.data(),
			size(xy_plane_indices), layout};
		...
		while (true) {
			...
			glDrawElements(GL_TRIANGLES, xy_plane.size(), GL_UNSIGNED_INT, 0);
