// Ogl vertices only mesh sample. Rendered by glDrawArrays function (for OpenGL ES 3.2).
#include <iostream>
#include <cassert>
#include <SDL.h>
...
int main([[maybe_unused]] int argc, [[maybe_unused]] char * argv[]) {
	...
	{  // scope to destroy ogl stuff before GL context delete
		...
		ogl::mesh xy_plane{xy_plane_verts, sizeof(xy_plane_verts), 6, layout};
		...
		while (true) {
			...
			glDrawArrays(GL_TRIANGLES, 0, xy_plane.size());
